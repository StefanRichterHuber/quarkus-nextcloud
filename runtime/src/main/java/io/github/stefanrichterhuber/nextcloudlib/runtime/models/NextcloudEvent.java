 ...
 * triggered.
 *
 * @param <T>   the type of the event data, must be an implementation of {@link Event}
...
public record NextcloudEvent<T extends io.github.stefanrichterhuber.nextcloudlib.runtime.models.NextcloudEvent.Event>(
         ...
         *                  is not available for the event type (e.g. before-create events)
         */
        public record FileEvent(@JsonProperty("class") String className, @Nullable Node node) implements Event {
                 ...
                 * @param path the server-relative path of the node (e.g. {@code /alice/files/report.pdf})
                 */
         ...
         *
         * @param className the fully-qualified Nextcloud PHP event class name
         * @param source    the original file-system node, or {@code null} for before-events
         *                  where the source may not be resolved yet
         * @param target    the destination file-system node, or {@code null} for before-events
         ...
         * @param objectIds  the identifiers of the objects the tag was assigned to or removed from
         * @param tagIds     the identifiers of the system tags that were assigned or removed
         */
         ...
         *
         * @param className    the fully-qualified Nextcloud PHP event class name
         * @param calendarId   the internal identifier of the calendar that owns the object
         * @param calendarData metadata about the calendar that owns the object
         * @param shares       the sharing state of the calendar at the time of the event
         * @param objectData   metadata about the calendar object (e.g. an event or task)
         */
        public record CalendarObjectEvent(
                 ...
                 * @param getctag                      the CalDAV CTag used to detect collection-level changes
                 * @param syncToken                    the WebDAV sync-token for incremental synchronisation
                 * @param supportedCalendarComponentSet the set of supported component types (e.g. VEVENT, VTODO)
                 * @param scheduleCalendarTransp        the scheduling transparency of the calendar
                 */
                 ...
                 * @param groupShare  {@code true} if this share targets a group rather than an individual user
                 */
                 ...
                 * @param etag           the ETag of the calendar object used for conflict detection
                 * @param calendarId     the internal identifier of the owning calendar
                 * @param size           the size of the iCalendar data in bytes
                 * @param component      the iCalendar component type (e.g. {@code VEVENT}, {@code VTODO})
                 * @param classification the classification level of the object (e.g. 0 = public, 1 = private)
                 */
         ...
         *
         * @param className          the fully-qualified Nextcloud PHP event class name
         * @param sourceCalendarId   the internal identifier of the calendar the object was moved from
         * @param targetCalendarId   the internal identifier of the calendar the object was moved to
         ...
         * @param sourceShares       the sharing state of the origin calendar at the time of the event
         * @param targetShares       the sharing state of the destination calendar at the time of the event
         */
