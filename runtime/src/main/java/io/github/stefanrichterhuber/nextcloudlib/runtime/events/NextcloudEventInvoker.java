...
/**
 * Build-time-generated invoker for a single {@link OnNextcloudEvent}-annotated method.
 *
 * <p>
 ...
 * using Gizmo. The generated class casts the {@code bean} to the declaring CDI bean type
 * and calls the handler method directly — no reflection at request time.
 * </p>
 */
public interface NextcloudEventInvoker {
    void invoke(Object bean, NextcloudEvent<?> event);
}
